...
pub static FIRST_SEEN_TABLE: LazyLock<BTreeMap<TableName, DatabaseVersion>> = LazyLock::new(|| {
    btreemap! {
        ...
        SCHEMA_MIGRATIONS_TABLE.clone() => 126,
        SCHEMA_MIGRATION_PROGRESS_TABLE.clone() => 126,
...
pub static FIRST_SEEN_INDEX: LazyLock<BTreeMap<IndexName, DatabaseVersion>> = LazyLock::new(|| {
    btreemap! {
        ...
        SCHEMA_MIGRATIONS_BY_MIGRATION_ID.name() => 126,
        SCHEMA_MIGRATION_PROGRESS_BY_SCHEMA_ID.name() => 126,
    }
});
